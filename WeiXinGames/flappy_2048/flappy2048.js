...
var flap = loadGameSound('music/flap.wav', 3);

var coin = loadGameSound('music/coin.wav', 1);

var punch = loadGameSound('music/punch.wav', 1);
...
wing.img = loadGameImage('image/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('image/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('image/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('image/gameover.png'); // 626 x 144
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('image/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('image/clicktostart.png'); // 337 x 75
...
sndo.div.style.backgroundImage = 'url("image/soundoff.png")';
sndo.has_sound = true;
...
ground.bit = loadGameImage('image/ground.png');
